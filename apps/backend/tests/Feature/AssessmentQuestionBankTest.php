...
class AssessmentQuestionBankTest extends TestCase
{
    ...
    public function test_assessment_navigation_is_localized_and_governance_matrix_records_surface(): void
    {
        App::setLocale('en');
        ...
        $this->assertStringContainsString('status: present_on_issue_183_branch', $matrix);
