    ...
    <main className="landing-shell" lang={locale} dir={direction} data-testid="modrik-landing-page">
      <header className="landing-nav">
        ...
        <div className="landing-nav-actions">
          ...
          <Link className="landing-login-link" href="/student" data-testid="modrik-student-login-entry">{text.loginLabel}</Link>
        </div>
      </header>
      ...
      <section className="landing-hero">
        ...
        <div className="landing-portals" aria-label="MODRIK demo portals">
          <article className="landing-portal-card landing-portal-student">
            ...
            <Link className="landing-primary-cta" href="/student" data-testid="modrik-student-portal-entry">{text.studentCta}</Link>
          </article>
          ...
          <article className="landing-portal-card landing-portal-admin">
            ...
            <p>{text.adminBody}</p>
            <a className="landing-secondary-cta" href={adminUrl} data-testid="modrik-admin-portal-entry">{text.adminCta}</a>
          </article>
        </div>
      </section>
