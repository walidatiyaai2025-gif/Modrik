...
log "Verifying public runtime endpoints"
...
[[ "$landing_body" == *'data-testid="modrik-student-portal-cta"'* ]] \
  || fail "Demo Landing Student Portal CTA is missing after copy."
[[ "$student_body" == *'data-testid="modrik-student-portal-route"'* ]] \
