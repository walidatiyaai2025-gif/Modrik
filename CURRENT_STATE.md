...
- P0-ACADEMIC-CONTRACT-002 / Issue #21: production onboarding/reset selection needs a Backend-owned authorized track catalogue with stable IDs and display-safe localized labels. Student Web deliberately does not invent real board/syllabus/version choices or eligibility rules.
...
Integrate PR #20 after its final evidence commit is green and conflict-reviewed, while the remaining Parallel Wave 1 agents continue Issues #14–#16 and #18–#19 on separate ownership branches. Resolve Issue #21 only through the Academic/Backend contract owner; do not implement a client-side track catalogue.
