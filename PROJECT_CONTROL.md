...
Updated: 2026-08-20
Control baseline main SHA: `97f73a74945052441f929ab3135cef349eaefc66`
...
- #32 — Public Landing/Help/guides/legal-trust engineering surfaces. Owner: Public/Release Web Agent.
...
- #21 may integrate independently once green;
- #30 and #31 may integrate independently after reconciliation against latest `main` while preserving Auth #15 authority;
- #32 may integrate independently only if `deploy/coming-soon/` remains intact and owner/legal facts remain explicit placeholders;
