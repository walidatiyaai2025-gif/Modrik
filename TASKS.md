...
- [x] P0-SYNC-001 / Issue #14 / REQ-P0-006 / AC-P0-009 — resumable idempotent offline answer sync; PR #25 is integrated on `main` by merge commit `00f24ff3125dd2af212f914c7e87f8981d7d003e`. The merged contract provides ordered 1–100 batches, actor-scoped HMAC operation IDs, immutable operation payload identity, durable ACK/replay/conflict semantics, revision recovery, and preserves authoritative AttemptService/outbox behavior.
- [x] P0-AUTH-001 / Issue #15 / REQ-P0-001 / AC-P0-013 — production account lifecycle and provider-linking architecture is integrated through PR #24 by merge commit `4dafe1b7eda839cd250ebfd89df5db7b5aa48a8f`. Final tested head `34e450eed3761e7225034779ac27e420ae6cf94a` passed all seven jobs in Bootstrap CI run `32394949281`; merged-tree comparison was identical to the tested tree. Production Google/Apple secrets/config remain external owner inputs.
- [x] P0-ASSESS-001 / Issue #16 / REQ-P0-005 / AC-P0-002..005 — authoritative quiz/exam randomization is integrated on `main` through PR #23 by merge commit `370939f5f8aba6b1b8d3e3a0459453f56f375b31`. Every new attempt has a cryptographically secure server-owned seed, blueprint-constrained set rotation, persisted non-static authoritative ordering, opt-in safe option shuffling, immutable same-attempt resume/grading/scope snapshots, and no client scoring/seed/order authority. Final evidence head `ed069a046334b14b6684940210e62c88357ca569` passed all seven jobs in run `32390376040`.
...
- [x] P0-MOBILE-001 / Issue #18 / REQ-P0-008/012 / AC-P0-014 — Flutter Android/iOS shell, onboarding/context, dashboard, study, practice and progress; AR/EN/FR + RTL/LTR/accessibility/offline/stale UX; production opaque Auth bearer compatibility; exact Assessment attempt/option order and same-attempt resume; merged Sync `/v1/sync/answers` with immutable operation ID/payload, JSON-shaped scalar/array answer values, durable ACK/replay/conflict handling and authoritative revision recovery; no client scoring/seed/order authority. Reconciled code head `b9e420580daa38541839e1a92054d30722893303` passed all seven jobs in run `32396448445`; this documentation reconciliation requires one fresh seven-job pass before PR #22 can merge.
- [ ] P0-ADMIN-001 / Issue #19 / REQ-P0-003/004/009 / AC-P0-001/006..008 — Filament Preparation Wizard, returned-ZIP binding, stale-settings regeneration, dry-run/diff/review, authorized idempotent official-content publication and operational retry visibility; must be reconciled after Mobile and pass the full seven-job matrix before merge.
