...
- [ ] P0-OPS-001 / Issue #10 / REQ-P0-009/014 / AC-P0-016..017 — implement a database/cron-compatible bounded, overlap-safe, resumable, idempotent-by-event-ID, observable outbox worker with capped backoff and redacted failure history. Local Backend (19 tests/493 assertions) and migration round trip pass; full repository gates and GitHub/MariaDB CI remain pending.
