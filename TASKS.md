...
- [x] P0-MOBILE-001 / Issue #18 / REQ-P0-008/012 / AC-P0-014 — Android/iOS Flutter onboarding/academic context, dashboard, study, practice, progress, AR/EN/FR + RTL/LTR, accessible/failure/offline states, exact Backend-authoritative attempt resume/order, local downloaded-content/attempt cache boundaries, and canonical Issue #14 pending-answer sync consumption are implementation-complete on PR #22. Clean code head `ef232a04032fee09307db0b2f382885c428789cd` passed Bootstrap CI run `32388953204` across all seven jobs. Windows remains deferred; Mobile owns no scoring, seed/order, academic-transition, age/ad or publication authority.
