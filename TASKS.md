...
- [x] P0-AUTH-001 / Issue #15 / REQ-P0-001 / AC-P0-013 — production email/password registration/login, verification/resend/rate limiting, enumeration-resistant recovery/reset, opaque backend-owned sessions and revocation, recent-auth sensitive actions, safe logical account deletion, Google/Apple stable-subject provider linking/collision behavior, Apple relay-safe identity handling, fixture isolation, Auth-owned OpenAPI/RFC9457/data/security/QA traceability, and SQLite/MariaDB coverage. Closure evidence head `507a25558e9bf114b99a0ce12781c7eb178a3300` passed all seven Bootstrap CI jobs in run `32393926820`; documentation reconciliation requires one fresh seven-job pass before PR #24 can merge.
...
- [ ] P0-MOBILE-001 / Issue #18 / REQ-P0-008/012 / AC-P0-014 — Flutter Android/iOS learning flows, accessibility and offline client boundary; earlier implementation evidence must be reconciled onto latest `main` after Auth and revalidated against merged Assessment + Sync + production Auth/session contracts before merge.
